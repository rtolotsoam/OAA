...
class Notification extends CI_Controller{
    ...
    public function notification()
    {
        ...
        if($this->session->userdata('loggin') && $level == 'admin'){
            ...
            $var_url_accueil           = "var url_accueil = "."\"".site_url("back/notification")."\";";
            
            
            $var_url_ajout_notif    = "var url_ajout_notif = "."\"".site_url("back/notification/ajouter")."\";";
            $var_url_modif_notif    = "var url_modif_notif = "."\"".site_url("back/notification/modifier")."\";";
            $var_url_suppr_notif    = "var url_suppr_notif = "."\"".site_url("back/notification/supprimer")."\";";
            $var_url_aff_suppr_notif    = "var url_aff_suppr_notif = "."\"".site_url("back/notification/affiche_suppr_notification")."\";";
            $var_url_after_op_notif = "var url_after_op_notif = "."\"".site_url("back/notification")."\";";
            $var_url_login_notif    = "var url_login_notif = "."\"".site_url("back/login")."\";";
            $var_url_recup_notif    = "var url_recup_notif = "."\"".site_url("back/notification/la_notification")."\";";
            
            //** PARAMETRE VUE **
            $data['titre']   = 'NOTIFICATION';
            $data['css']     = array('admin/module.admin.page.tables.min','admin/module.global','admin/notification_maj'); 
            $data['level']   = $level;  
            $data['prenom']  = $this->session->userdata('prenom');
            $data['js_info'] = array($var_url_ajout_notif, $var_url_modif_notif, $var_url_suppr_notif, $var_url_after_op_notif, $var_url_login_notif, $var_url_recup_notif, $var_url_modif_user_profil, $var_url_accueil, $var_url_aff_suppr_notif );
