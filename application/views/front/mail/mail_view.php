...
if (isset($statut) && $statut == '1') {
    ?>
				...
				Votre compte a été créer pour utiliser l'outil d'aide à l'agent CPE.
    ...
    ?>
				...
				Merci d'avoir renseigner votre adresse E-mail, pour utiliser l'outil d'aide à l'agent CPE.

			<?php
} else if (isset($statut) && $statut == 'modif_pass_mail') {
    ?>

				Merci d'avoir renseigner votre adresse E-mail et votre mot de passe est modifier, pour utiliser l'outil d'aide à l'agent CPE.
...
?>
		...
		<ol>
			...
			<li>Lien : <a href="http://aide-agent.vivetic.com:8888/OAA">http://aide-agent.vivetic.com:8888/OAA</a></li>
		</ol>
		<p>Cordialement,</p>
		<hr size="0" style="
